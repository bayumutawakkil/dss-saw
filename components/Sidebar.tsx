    ...
    <>
      ...
      <header className="md:hidden fixed top-0 left-0 right-0 z-50 bg-blue-950 text-white px-4 h-16 flex items-center justify-between border-b border-blue-800 shadow-md">
        <div className="flex items-center gap-3">
          ...
          <span className="font-bold tracking-wide text-sm">SPK-Workshop</span>
        </div>
        <button
          onClick={() => setIsOpen(!isOpen)}
          className="p-2 rounded-md hover:bg-blue-800 transition-colors duration-200 focus:outline-none"
      ...
      `}>
        ...
        <div className="hidden md:block px-6 py-8 border-b border-blue-800/50">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-base font-bold leading-tight tracking-wide">SPK-Workshop</p>
